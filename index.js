...
const ElkConnection = function (opts) {
  ...
  this.useSecure = (opts.useSecure === true)
...
ElkConnection.prototype.writesd = function (type, address) {
  this._connection.write(messaging.writeTextDescriptionsMessage('sd', type, address))
}

ElkConnection.prototype.writecmd = function (cmd) {
  this._connection.write(messaging.writeAscii(cmd))
}
