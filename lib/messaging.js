...
var writeArmingMessage = function (cmd, opts) {
  ...
  // fixme 'instant' is assigned a value but never used.
...
var writeValidUserCodeMessage = function (cmd, userCode) {
  userCode = ('000000' + userCode).substr(-6)
  var reserved = '0'
  var msg = writeAscii(cmd + userCode.toString() + reserved)
  return msg
}

var writeSystemLogMessage = function (cmd, logEntry) {
  logEntry = ('000' + logEntry).substr(-3)
  var msg = writeAscii(cmd + logEntry.toString())
  return msg
}
...
module.exports.writeValidUserCodeMessage = writeValidUserCodeMessage
module.exports.writePowerLineCarrierChangeMessage = writePowerLineCarrierChangeMessage
module.exports.writeSystemLogMessage = writeSystemLogMessage
