...
const parseRealtimeClockData = function (msgData) {
  ...
  msgData.data.dayfirst = (parseInt(msgData.dataRaw.substring(15, 16)) === 1)
  msgData.data.clock24 = (parseInt(msgData.dataRaw.substring(14, 15)) === 0)
  msgData.data.clockdst = (parseInt(msgData.dataRaw.substring(13, 14)) === 1)
