...
const parseVersionNumberData = function (msgData) {
  msgData.data.m1Version = msgData.dataRaw.substring(0, 2) + '.' + msgData.dataRaw.substring(2, 4) + '.' + msgData.dataRaw.substring(4, 6)
  msgData.data.m1expVersion = msgData.dataRaw.substring(6, 8) + '.' + msgData.dataRaw.substring(8, 10) + '.' + msgData.dataRaw.substring(10, 12)
}
