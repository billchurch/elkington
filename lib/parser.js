...
// fixme 'parseValidUserCodeAreasData' is assigned a value but never used.
...
var parseValidUserCodeData = function (msgData) {
  msgData.data.userCode = msgData.dataRaw.substring(0, 6)
...
var parseValidUserNumberData = function (msgData) {
